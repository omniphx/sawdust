...
export function PropertiesPanel({ isMiterMode = false, miterDraft = null, onMiterDraftChange }: PropertiesPanelProps) {
  ...
  return (
    <div className="w-72 bg-white border-l border-slate-200 p-4 overflow-y-auto">
      ...
      <div className="space-y-6">
        ...
        {/* Miter Saw Cut Beta */}
        <div>
          <h3 className="text-slate-600 text-sm font-medium mb-2">Miter Saw Cut (Beta)</h3>
          {!isMiterMode && (
            <p className="text-xs text-slate-500 mb-2">
              Enable Miter Beta in the toolbar, then click an edge on this box.
            </p>
          )}
